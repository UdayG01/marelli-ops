...
class FlexibleNutDetectionService:
    ...
    def visualize_region_selector(self, image_path: str) -> Dict[str, List[int]]:
        ...
        def click_event(event, x, y, flags, param):
            nonlocal points, img_copy, scale_factor
        ...
        # Resize image
        displayed_img = cv2.resize(img, (new_width, new_height), interpolation=cv2.INTER_AREA)
        img_copy = displayed_img.copy()
        ...
        if len(points) == 4:
            ...
            print("\nSelected Region Points (Original Image Coordinates):")
            print(f"region = {{")
            print(f"    'points': [")
