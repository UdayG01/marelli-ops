...
urlpatterns = [
    ...
    # Server refresh endpoints
    path('refresh-server/', refresh_server, name='refresh_server'),
    path('trigger-batch-refresh/', trigger_batch_refresh, name='trigger_batch_refresh'),
    path('reset-trigger-count/', reset_trigger_count, name='reset_trigger_count'),
